...
- (MJRefreshLegendFooter *)addLegendFooterWithRefreshingBlock:(void (^)())block noMoreDataTitle:(NSString *)noMoreDataTitle
{
    MJRefreshLegendFooter *footer = [self addLegendFooter];
    [footer setTitle:noMoreDataTitle forState:MJRefreshFooterStateNoMoreData];
    footer.refreshingBlock = block;
    return footer;
}
