...
- (void)commonInit {
    ...
    UIColor *commonLinkColor = ColorAttionCanBackground;
...
- (void)setText:(id)text
{
    ...
    NSRegularExpression * const regexps[] = {kURLRegularExpression(),kEmailRegularExpression(),kPhoneNumerRegularExpression(),kPoundSignRegularExpression(),kAtRegularExpression()};
