...
extern NSString* stringLink(NSString* str,NSString *str2);
extern NSString* unitLink(NSString* str);
extern NSString* stringUnitLink(NSString* str,NSString *str2);
extern BOOL stringIsEqual(NSString* str,NSString *str2);
